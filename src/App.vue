...
import CheckupsView from './views/CheckupsView.vue'
import ProfileView from './views/ProfileView.vue'

type ViewName = 'home' | 'members' | 'medicines' | 'medication' | 'records' | 'checkups' | 'profile'
